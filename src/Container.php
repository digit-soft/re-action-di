 ...
 *
 * $db = new \Reaction\Db\Database(['user' => '...']);
 ...
 */
class Container extends Component implements ExtendedContainerInterface
{
    /**
     ...
     * @see ExtendedContainerInterface::set()
     */
     ...
     *
     * If the class implements [[\Reaction\Base\Configurable]], the `$config` parameter will be passed as the last
     ...
     * @throws EntryNotFoundException If entry with given ID|className not defined
     */
